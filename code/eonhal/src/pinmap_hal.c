 ...
 */
        ...
        /* PB13 - 29*/ {GPIOB, LL_GPIO_PIN_13, ADC_CHANNEL_NONE, TIM21, LL_TIM_CHANNEL_CH1, AF_6, AF_0, AF_5, AF_NONE},
...
#if defined(CMWX1ZZABZ_091)
        /* PA0 - 0*/ {GPIOA, LL_GPIO_PIN_0, LL_ADC_CHANNEL_0, TIM2, LL_TIM_CHANNEL_CH1, AF_2, AF_NONE, AF_NONE, AF_6},
        /* PA2 - 1*/ {GPIOA, LL_GPIO_PIN_2, LL_ADC_CHANNEL_2, TIM2, LL_TIM_CHANNEL_CH3, AF_2, AF_NONE, AF_NONE, AF_4},
        /* PA3 - 2*/ {GPIOA, LL_GPIO_PIN_3, LL_ADC_CHANNEL_3, TIM2, LL_TIM_CHANNEL_CH4, AF_2, AF_NONE, AF_NONE, AF_4},
        /* PA4 - 3*/ {GPIOA, LL_GPIO_PIN_4, LL_ADC_CHANNEL_4, NULL, TIM_CHANNEL_NONE, AF_NONE, AF_NONE, AF_NONE, AF_NONE},
        /* PA5 - 4*/ {GPIOA, LL_GPIO_PIN_5, LL_ADC_CHANNEL_5, TIM2, LL_TIM_CHANNEL_CH1, AF_5, AF_0, AF_NONE, AF_NONE},
        /* PA8 - 5*/ {GPIOA, LL_GPIO_PIN_8, ADC_CHANNEL_NONE, NULL, TIM_CHANNEL_NONE, AF_NONE, AF_NONE, AF_7, AF_NONE},
        /* PA9 - 6*/ {GPIOA, LL_GPIO_PIN_9, ADC_CHANNEL_NONE, NULL, TIM_CHANNEL_NONE, AF_NONE, AF_NONE, AF_6, AF_4},
        /* PA10 - 7*/ {GPIOA, LL_GPIO_PIN_10, ADC_CHANNEL_NONE, NULL, TIM_CHANNEL_NONE, AF_NONE, AF_NONE, AF_6, AF_4},
        /* PA11 - 8*/ {GPIOA, LL_GPIO_PIN_11, ADC_CHANNEL_NONE, NULL, TIM_CHANNEL_NONE, AF_NONE, AF_0, AF_NONE, AF_NONE},
        /* PA12 - 9*/ {GPIOA, LL_GPIO_PIN_12, ADC_CHANNEL_NONE, NULL, TIM_CHANNEL_NONE, AF_NONE, AF_0, AF_NONE, AF_NONE},
        /* PA13 - 10*/ {GPIOA, LL_GPIO_PIN_13, ADC_CHANNEL_NONE, NULL, TIM_CHANNEL_NONE, AF_NONE, AF_NONE, AF_NONE, AF_NONE},
        /* PA14 - 11*/ {GPIOA, LL_GPIO_PIN_14, ADC_CHANNEL_NONE, NULL, TIM_CHANNEL_NONE, AF_NONE, AF_NONE, AF_NONE, AF_4},

        /* PB2 - 12*/ {GPIOB, LL_GPIO_PIN_2, ADC_CHANNEL_NONE, NULL, TIM_CHANNEL_NONE, AF_NONE, AF_NONE, AF_NONE, AF_NONE},
        /* PB5 - 13*/ {GPIOB, LL_GPIO_PIN_5, ADC_CHANNEL_NONE, TIM22, LL_TIM_CHANNEL_CH2, AF_4, AF_0, AF_NONE, AF_NONE},
        /* PB6 - 14*/ {GPIOB, LL_GPIO_PIN_6, ADC_CHANNEL_NONE, NULL, TIM_CHANNEL_NONE, AF_NONE, AF_NONE, AF_1, AF_0},
        /* PB7 - 15*/ {GPIOB, LL_GPIO_PIN_7, ADC_CHANNEL_NONE, NULL, TIM_CHANNEL_NONE, AF_NONE, AF_NONE, AF_1, AF_0},
        /* PB8 - 16*/ {GPIOB, LL_GPIO_PIN_8, ADC_CHANNEL_NONE, NULL, TIM_CHANNEL_NONE, AF_NONE, AF_NONE, AF_4, AF_NONE},
        /* PB9 - 17*/ {GPIOB, LL_GPIO_PIN_9, ADC_CHANNEL_NONE, NULL, TIM_CHANNEL_NONE, AF_NONE, AF_NONE, AF_4, AF_NONE},
        /* PB12 - 18*/ {GPIOB, LL_GPIO_PIN_12, ADC_CHANNEL_NONE, NULL, TIM_CHANNEL_NONE, AF_NONE, AF_NONE, AF_NONE, AF_NONE},
        /* PB13 - 19*/ {GPIOB, LL_GPIO_PIN_13, ADC_CHANNEL_NONE, TIM21, LL_TIM_CHANNEL_CH1, AF_6, AF_0, AF_5, AF_NONE},
        /* PB14 - 20*/ {GPIOB, LL_GPIO_PIN_14, ADC_CHANNEL_NONE, TIM21, LL_TIM_CHANNEL_CH2, AF_6, AF_0, AF_5, AF_NONE},
        /* PB15 - 21*/ {GPIOB, LL_GPIO_PIN_15, ADC_CHANNEL_NONE, NULL, TIM_CHANNEL_NONE, AF_NONE, AF_0, AF_NONE, AF_NONE},
